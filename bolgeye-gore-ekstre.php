...
$sql = "SELECT DISTINCT sehir FROM musteriler WHERE durum = 0 ORDER BY sehir ASC";
$stmt = $db->prepare($sql);
$stmt->execute();
...
<head>
     ...
     <meta charset="utf-8" />
    <title>Bölge Ekstresi | Nextario Muhasebe Programı</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 class="mb-sm-0">Bölge Ekstresi</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Nextario</a></li>
                                        <li class="breadcrumb-item active">Bölge Ekstresi</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Bölge Ekstresi</h5>
                                </div>
                                <div class="card-body">
                      <form action="bolge-ekstre-sonuc.php" method="POST">
