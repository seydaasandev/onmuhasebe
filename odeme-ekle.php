...
<head>
     ...
     <meta charset="utf-8" />
    <title>Yeni Ödeme Ekle | Nextario Muhasebe Programı</title>
...
<?php require "head.php"; ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 class="mb-sm-0">Ödeme Ekle</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Ödeme Ekle</h5>
                                </div>
                                <div class="card-body">
                      <form action="islem.php?islem=odeme_ekle" method="POST">

    <!-- MÜŞTERİ -->
        <div class="mb-3">
        <label class="form-label">Müşteri Adı</label>
        <select name="musteri_id" class="js-example-basic-single" required>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="makbuz_no" class="form-control">
    </div>
    ...
    <button type="submit" class="btn btn-primary rounded-pill">
        <i class="ri-money-dollar-circle-line me-1"></i> Ödeme Ekle
    </button>
