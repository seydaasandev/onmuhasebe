...
$sql = $db->prepare("SELECT * FROM users WHERE durum = 0 ORDER BY id DESC");
$sql->execute();
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Kullanıcılar Tablosu</h5>
                                </div>
                                <div class="card-body">
    ...
    <tbody>
        ...
        <?php foreach ($users as $user): ?>
            <tr>
                ...
                <td>
                    <a href="kullanici-duzenle.php?id=<?= $user['id'] ?>" class="btn btn-primary btn-sm">
                        Düzenle
                    </a>

                    <a href="#" 
   class="btn btn-danger btn-sm userSilBtn" 
   data-id="<?= $user['id'] ?>">
   Sil
</a>
                </td>
...
document.addEventListener('click', function(e) {
    const btn = e.target.closest('.userSilBtn');
    if (!btn) return;
    ...
    Swal.fire({
        ...
        didOpen: () => {
            ...
            silBtn.addEventListener("click", () => {
                window.location.href = "islem.php?islem=user_sil&id=" + userID;
            });
