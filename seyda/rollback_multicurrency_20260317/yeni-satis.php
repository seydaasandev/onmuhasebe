...
$musteriler = $db->query("SELECT id, musteri_adi FROM musteriler WHERE durum = 0 ORDER BY id ASC")->fetchAll(PDO::FETCH_ASSOC);
?>
...
<head>
<meta charset="utf-8" />
<title>Yeni Satış | Nextario Muhasebe</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 class="mb-sm-0">Yeni Satış</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Nextario</a></li>
                                        <li class="breadcrumb-item">Yeni Satış Ekle</li>
                                    </ol>
                                </div>
  ...
  <div class="col-xl-12">
    <div class="card">
      <div class="card-header bg-primary text-white">
          <span class="badge badge-label bg-info"><i class="mdi mdi-circle-medium"></i> Yeni Satış Kaydı</span>
      
      </div>

      <div class="card-body form-steps">
        <form method="POST" action="islem.php?islem=satis_ekle" class="vertical-navs-step">
          <div class="row gy-4">
            ...
            <div class="col-lg-3 border-end">
              ...
              <div class="mt-4">
                ...
                <input type="number" id="faturano" name="faturano" class="form-control" required>
              </div>
            </div>
