        ...
        <div class="row g-0 login-frame">
            <div class="col-lg-7 brand-panel d-none d-lg-block">
                <div class="brand-overlay">
                    ...
                    <a href="index.php" class="d-inline-block mt-4">
                        <img src="assets/Nextario-b.png" alt="Nextario" height="86">
                    </a>
                    <h1 class="brand-title">Finansal operasyonlarınızı tek merkezden yönetin.</h1>
                    <p class="brand-copy">Satış, stok, tahsilat ve raporlama süreçlerini daha kontrollü, daha izlenebilir ve daha profesyonel bir deneyimle yönetin. Nextario, günlük muhasebe akışını kurumsal standartta sadeleştirir.</p>
            ...
            <div class="col-12 col-lg-5 login-panel">
                <div class="login-stack">
                    <div class="mobile-brand">
                        ...
                        <div class="mt-3 fw-semibold">Kurumsal muhasebe ve stok takibi tek noktada.</div>
                    </div>
