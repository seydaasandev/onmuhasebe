...
$kurSor = $db->query("SELECT kur FROM kur LIMIT 1");
$kur = $kurSor->fetchColumn();
$kur = $kur ?: '';
...
<head>
     ...
     <meta charset="utf-8" />
    <title>Ürün Fiyat Güncelle | Nextario Muhasebe Programı</title>
...
<?php require "head.php"; ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 class="mb-sm-0">Ürün Fiyat Güncelle</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Nextario</a></li>
                                        <li class="breadcrumb-item active">Ürün Fiyat Güncelle</li>
                                    </ol>
                                </div>
   ...
   <div class="mb-3 col-4">
            <label class="form-label">Mevcut Euro Kuru</label>
            <input type="number" step="0.01" name="kur"
                   class="form-control"
                   value="<?= $kur ?>" required>
        </div>
