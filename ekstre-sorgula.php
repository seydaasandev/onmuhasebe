...
<head>
     ...
     <meta charset="utf-8" />
    <title>Müşteri Ekstresi | Nextario Muhasebe Programı</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 class="mb-sm-0">Müşteri Ekstresi</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Nextario</a></li>
                                        <li class="breadcrumb-item active">Müşteri Ekstresi</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Müşteri Ekstresi</h5>
                                </div>
                                <div class="card-body">
                      <form action="ekstre-sonuc.php" method="POST">
