            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-xl-4 text-center">
                        ...
                        <div>
                            <h4>Bu sayfayı görüntülemek için yetkiniz yok!</h4>
                            <p class="text-muted w-75 mx-auto">Bu sayfayı görünteleyebilmek için yönetici rolünda olmanız gerekmektedir. Bir yanlışlık olduğunu düşünüyosanız lütfen sistem yöneticisine başvurun.</p>
                            <a href="index.html" class="btn btn-success"><i class="mdi mdi-home me-1"></i>Anasayfaya Dön</a>
                        </div>
                    </div><!-- end col-->
                </div>
                <!-- end row -->
