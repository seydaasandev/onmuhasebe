...
<head>
     ...
     <meta charset="utf-8" />
    <title>Kullanıcılar | Nextario Muhasebe Programı</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 class="mb-sm-0">Kullanıcı Düzenle |  <?= $user['username'] ?></h4>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <form action="islem.php?islem=kullanici_duzenle" method="POST">
            ...
            <div class="col-6">
              ...
              <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="text" name="namesurname" class="form-control" value="<?= $user['namesurname'] ?>" required>
                </div>
            </div>
    ...
    Kullanıcılara Dön
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                 <form action="islem.php?islem=sifre_duzenle" method="POST">
                <input type="hidden" name="id" value="<?= $user['id'] ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-end">
                        <button type="submit" class="btn btn-warning rounded-pill">
                            <i class="ri-lock-password-line me-1"></i> Şifreyi Güncelle
                        </button>
                    </div>
                </div>
            </form>
...
<script>
Swal.fire({
    icon: "<?= $_SESSION['mesaj'] === 'ok' ? 'success' : 'error' ?>",
    title: "<?= $_SESSION['mesaj'] === 'ok' ? 'Şifre Güncellendi' : 'Şifre Güncellenemedi' ?>",
...
<?php if(isset($_SESSION['mesaj2'])): ?>
<script>
Swal.fire({
    icon: "<?php echo $_SESSION['mesaj2']=='duzenle_ok' ? 'success' : 'error'; ?>",
    title: "<?php echo $_SESSION['mesaj2']=='duzenle_ok' ? 'Güncellendi' : 'Güncellenemedi'; ?>"
});
</script>
<?php unset($_SESSION['mesaj2']); endif; ?>
