...
<?php require "head.php"; ?>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Ödemeler Tablosu</h5>
                                </div>
                                <div class="card-body">
                                        <div class="row mb-3">
    <div class="col-md-3">
    ...
    <div class="col-md-2">
        <button id="filterBtn" class="btn btn-primary">Filtrele</button>
                              ...
                              <table id="odemeler" class="display table table-bordered dt-responsive dataTable dtr-inline collapsed" style="width:100%"> 
                              <thead> <tr> 
                              <th>ID</th> 
                              <th>Müşteri</th> 
                              <th>Tutar</th>
...
document.addEventListener('click', function(e) {
    const btn = e.target.closest('.odemeSilBtn');
    if (!btn) return;

    e.preventDefault();
    let odemeID = btn.getAttribute("data-id");

    Swal.fire({
        title: "Ödeme silmek istediğinize emin misiniz?",
        ...
        didOpen: () => {
            ...
            silBtn.addEventListener("click", () => {
                window.location.href = "islem.php?islem=odeme_sil&id=" + odemeID;
            });
